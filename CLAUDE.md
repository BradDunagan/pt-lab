...
- Keep the framework boundary: the editor API is plain-data methods/callbacks (`listObjects`, `setObjectMaterial`, `setLight`, `serializeScene`, `applyScene`, `importGLB`, `onObjectsChanged`, `onLightsChanged`) — no three.js types cross into Svelte.
